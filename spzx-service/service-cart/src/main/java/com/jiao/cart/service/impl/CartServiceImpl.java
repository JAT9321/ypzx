...
public class CartServiceImpl implements CartService {
    ...
    public List<CartInfo> getCartList() {
        ...
        List<Object> carList = redisTemplate.opsForHash().values(cartKey);
        if (!CollectionUtils.isEmpty(carList)) {
            List<CartInfo> cartInfoList = carList.stream().map(cartInfo -> JSON.parseObject(cartInfo.toString(), CartInfo.class))
